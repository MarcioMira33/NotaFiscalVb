...
Public Class Cancelamento
    ...
    Public Function CancelarNota(NumLote As String, TipoPessoa As String) As Boolean
        ...
        Try
            NomeArq = sCancelamento & chNFe & "-ped-can.xml"
            ...
            With wrt
                ...
                .WriteAttributeString("versao", "1.20")
                .WriteStartElement("infEvento")
                .WriteAttributeString("Id", "ID110111" & chNFe)
                .WriteElementString("cOrgao", "91")
                .WriteElementString("tpAmp", TpAmb)
                If TipoPessoa = "F" Then
                    .WriteElementString("CPF", CpfCnpj)
                Else
                    .WriteElementString("CNPJ", CpfCnpj)
                End If
                .WriteElementString("chNFe", chNFe)
                .WriteElementString("dhEvento", dhEvento)
                .WriteElementString("nSeqEvento", "1")
                .WriteElementString("verEvento", "1.20")
                .WriteElementString("detEvento", detEvento)
                .WriteElementString("versao", "1.20")
                .WriteElementString("descEvento", descEnvento)
                .WriteElementString("nProt", nProt)
                .WriteElementString("xJust", xJust)
            ...
            Dim clsAssin As New AssinarXml()

            If NomeCertificado = "" Then
                _X509Cert = clsAssin.BuscarNome("")
                NomeCertificado = _X509Cert.Subject
            Else
                _X509Cert = clsAssin.BuscarNome(NomeCertificado)
            End If
            ...
            Dim NomeArqRet As String = sCancelamento & "Ret_Cance" & "Id" & chNFe + ".xml"
